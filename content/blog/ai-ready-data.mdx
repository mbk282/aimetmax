...
Ik hoor het regelmatig: "We willen iets met AI, maar onze data is er nog niet klaar voor." Vaak is dat een excuus om niets te doen. Toch zit er een kern van waarheid in. De meeste AI-projecten mislukken niet door de technologie. Ze mislukken door de data.
...
In veel CRM's staan klanten die geen klant meer zijn, contactpersonen die van functie zijn veranderd, en dubbele records. Niemand ruimt het op, want het lijkt geen prioriteit.
...
**Wat je kunt doen:** Focus op naamgeving en structuur. Een consistent formaat als "[Projectnaam] - [Type] - [Datum]" maakt al een wereld van verschil. En tag documenten met metadata: type, afdeling, status. Twijfel je of een specifiek document geschikt is om aan een AI-tool te voeren? Met de [AI Readiness Scorer](/tools/ai-readiness-scorer) check je of een document AI- en RAG-ready is.
...
**Kies één use case.** Niet "we gaan al onze data op orde brengen", maar "we willen dat onze AI-assistent onze contracten kan doorzoeken."
...
**Hoeveel data heb ik nodig voor AI?**
Voor de meeste zakelijke toepassingen (zoeken, samenvatten, analyseren) heb je geen enorme datasets nodig. Als je genoeg data hebt om een mens de taak te laten doen, heb je genoeg voor AI. De uitzondering: als je een eigen model wilt trainen. Maar dat is voor de meeste organisaties niet aan de orde.

**Moet al mijn data digitaal zijn?**
Voor AI-toepassingen: ja. Papieren archieven die je wilt doorzoeken moeten eerst gedigitaliseerd worden. Gebruik de [PDF naar Markdown converter](/tools/pdf-naar-markdown) om gescande documenten om te zetten naar doorzoekbare tekst.

**Is mijn data privacygevoelig?**
Waarschijnlijk deels wel. Maak onderscheid tussen data die je in publieke AI-tools kunt gebruiken (niet-persoonsgebonden, niet-vertrouwelijk) en data waarvoor je een privé-oplossing nodig hebt (bijvoorbeeld AI-tools zoals Microsoft Copilot binnen je eigen tenant, of een eigen RAG-oplossing).
...
Wil je eerst je eigen begrip van AI op orde? In de [gratis AI-academy](/academy) leg ik in korte modules uit wat AI is, hoe het werkt en hoe je er praktisch mee werkt - een laagdrempelige manier om je team op één lijn te krijgen voordat je een dataproject start.

En als je voor een concrete use case wilt sparren over je data en een aanpak op maat wilt, [neem dan contact op](/contact). Ik bouw maatwerk e-learnings en help organisaties hun eerste AI-project van data tot werkend prototype rond te krijgen.
