...
export async function leesVoorraad(): Promise<number | null> {
  ...
  // Een foute of verlopen sleutel, of een tijdelijke Stripe-hik, mag de hele
  // bestelpagina niet platleggen. Dan liever geen tellertje tonen.
  try {
    ...
    console.error("leesVoorraad: kon voorraad niet ophalen bij Stripe", e);
    return null;
  }
}
